...
`1 MAC = 2 FLOPs`. Bias, normalization, activation, softmax, indexing and all
spatial/temporal interpolation paths are excluded. This includes
sparse-to-dense expansion einsums and framework interpolation kernels for every
model. Parameter counts include all model parameters.
...
| LPAN-L-Direct (task-adapted 32-to-256) | 669,396 | 2.634 | 5.268 |
| EDSR-lite | 304,716 | 4.983 | 9.966 |
| Spatial GCN | 25,344 | 0.021 | 0.043 |
| CNN-GRU | 32,962 | 1.434 | 2.869 |
...
input/output adapter; it is not the same architecture as LPAN-L-Direct
(`lpan_l_direct`).
...
| Model | Parameters | GMACs | GFLOPs |
|---|---:|---:|---:|
| LPAN-L-Direct (task-adapted 32-to-256) | 658,602 | 2.483 | 4.965 |
| EDSR-lite | 297,794 | 4.870 | 9.739 |
